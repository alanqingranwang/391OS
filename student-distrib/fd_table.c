...
void close_all_fd()
{
	...
	{
		(((process_array[current_process[sched_proc]])->fd_table)[halt_cnt]).fd_jump = NULL;
		(((process_array[current_process[sched_proc]])->fd_table)[halt_cnt]).inode_ptr = -1;
		(((process_array[current_process[sched_proc]])->fd_table)[halt_cnt]).file_position = 0;
		(((process_array[current_process[sched_proc]])->fd_table)[halt_cnt]).flags = FD_OFF;
	}
}
...
int32_t get_fd_index()
{
	...
	{
		if((((process_array[current_process[sched_proc]])->fd_table)[table_loop]).flags == FD_OFF) // available index
			return table_loop;
	}
...
int32_t set_fd_info(int32_t index, fd_t file_info)
{
	...
	(((process_array[current_process[sched_proc]])->fd_table)[index]).fd_jump = file_info.fd_jump;
	(((process_array[current_process[sched_proc]])->fd_table)[index]).inode_ptr = file_info.inode_ptr;
	(((process_array[current_process[sched_proc]])->fd_table)[index]).file_position = file_info.file_position;
	(((process_array[current_process[sched_proc]])->fd_table)[index]).flags = file_info.flags;
...
int32_t get_inode_ptr(int32_t index)
{
	...
	return (((process_array[current_process[sched_proc]])->fd_table)[index]).inode_ptr;
}
...
void close_fd(int32_t index)
{
	...
	// close everything
	(((process_array[current_process[sched_proc]])->fd_table)[index]).fd_jump = NULL;
	(((process_array[current_process[sched_proc]])->fd_table)[index]).inode_ptr = -1;
	(((process_array[current_process[sched_proc]])->fd_table)[index]).file_position = 0;
	(((process_array[current_process[sched_proc]])->fd_table)[index]).flags = FD_OFF;
}
...
{
	return (((process_array[current_process[sched_proc]])->fd_table)[index]).file_position;
}
...
void add_offset(int32_t index, uint32_t amt)
{
	...
	(((process_array[current_process[sched_proc]])->fd_table)[index]).file_position += amt;
}
...
int32_t check_valid_fd(int32_t index)
{
	...
	return (((process_array[current_process[sched_proc]])->fd_table)[index]).flags;
}
